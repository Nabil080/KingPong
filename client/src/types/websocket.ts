import { currentStepType } from "../classes/Game/Game"
...
export type InviteMessage = { type: "invite"; userId: number; targetId: number; options: GameOptions }
...
export type InviteReply = { type: "invite"; senderId: number; options: GameOptions }
